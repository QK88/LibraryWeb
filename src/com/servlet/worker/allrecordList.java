...
@WebServlet(name = "allrecordList",urlPatterns = "/allrecordList")
public class allrecordList extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<stuview> userAll = ud.getstuAll(1);//获取所有该用户已借书目的值，传给model
